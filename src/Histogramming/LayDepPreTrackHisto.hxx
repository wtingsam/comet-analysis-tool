#ifndef __LayDepPreTrackHisto_is_seen__
#define __LayDepPreTrackHisto_is_seen__
...
***/
class LayDepPreTrackHisto: public PreTrackHisto{
    public:
        void Excute(){
            Initialize();
            Fill();
        ...
        void Print(){
            std::cout << "## This is a layer dependent histogram class " << std::endl;
        }
